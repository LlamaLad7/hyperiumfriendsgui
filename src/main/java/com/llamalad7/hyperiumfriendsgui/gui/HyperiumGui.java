...
public abstract class HyperiumGui extends GuiScreen {
    ...
    public HyperiumGui() {
        lastResolution = new ScaledResolution(Minecraft.getMinecraft());
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        actions.clear();
        Gui.drawRect(0, 0, new ScaledResolution(Minecraft.getMinecraft()).getScaledWidth() * new ScaledResolution(Minecraft.getMinecraft()).getScaleFactor(),
                new ScaledResolution(Minecraft.getMinecraft()).getScaledHeight() * new ScaledResolution(Minecraft.getMinecraft()).getScaleFactor(), new Color(0, 0, 0, alpha).getRGB());
    ...
    protected String boldText(String first, String second) {
        return ChatColor.BOLD + first + ChatColor.GRAY + second;
    }
}
